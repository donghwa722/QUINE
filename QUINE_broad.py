...
if is_ub:
    time_array, ub_cost_array, ub_array = QUINE.quine(num_qubits, num_layers, U, U_qubits, 100, range(num_qubits))
...
plt.legend()
if is_ub:
    plt.savefig('text.png', dpi=200)
else:
    plt.savefig('Borad_lb_8_2_pos.png', dpi=200)
# plt.show()